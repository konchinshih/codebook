...
\subsection{Default}
\lstinputlisting{code/Default.txt}

\subsection{Vimrc}
\lstinputlisting{code/Vimrc.txt}

\subsection{Run.sh}
\lstinputlisting{code/Runsh.txt}

\subsection{Stress}
\lstinputlisting{code/Stress.txt}
...
\section{Python}
\subsection{I/O}
\lstinputlisting{code/PythonIO.txt}

\subsection{Decimal}
\lstinputlisting{code/PythonDecimal.txt}

\section{Data Structure}

\subsection{Heavy Light Decomposition}
\lstinputlisting{code/HeavyLightDecomposition.txt}

\section{DP}

\subsection{Aliens}
\lstinputlisting{code/Aliens.cpp}
...
\subsection{BCC - AP}
\lstinputlisting{code/BCC-AP.cpp}

\subsection{BCC - Bridge}
\lstinputlisting{code/BCC-Bridge.cpp}
...
\subsection{Z Value}
\lstinputlisting{code/Zval.cpp}

\subsection{Manacher}
\lstinputlisting{code/Manacher.txt}
...
\subsection{SA-IS}
\lstinputlisting{code/SA-IS.txt}

\subsection{Minimum Rotation}
\lstinputlisting{code/MinRotation.txt}

\subsection{Aho Corasick}
\lstinputlisting{code/ACAutomaton.txt}

\section{Geometry}

\subsection{Basic Operations}
\lstinputlisting{code/GeometryDefault.txt}

\subsection{InPoly}
\lstinputlisting{code/InPoly.txt}

\subsection{Sort by Angle}
\lstinputlisting{code/SortByAngle.txt}

\subsection{Line Intersect Check}
\lstinputlisting{code/LineIntersectCheck.txt}

\subsection{Line Intersection}
\lstinputlisting{code/LineIntersection.txt}

\subsection{Convex Hull}
\lstinputlisting{code/ConvexHull.txt}

\subsection{Polygon Area}
\lstinputlisting{code/PolygonArea.txt}
...
\lstinputlisting{code/MinEnclosingCircle.txt}

\subsection{Closest Pair of Points}
\lstinputlisting{code/ClosestPointPair.txt}

\subsection{PolyUnion}
\lstinputlisting{code/PolyUnion.txt}

% \subsection{Convex Hull Trick}
% \lstinputlisting{code/ConvexHullTrick.txt}

\subsection{Minkowski Sum}
\lstinputlisting{code/MinkowskiSum.txt}

\section{Number Theory}

\subsection{Pollard's rho}
\lstinputlisting{code/PollardRho.txt}

\subsection{Miller Rabin}
\lstinputlisting{code/MillerRabin.txt}
...
\subsection{Mu}
\lstinputlisting{code/Mu.txt}

\subsection{Phi}
\lstinputlisting{code/Phi.txt}
...
\lstinputlisting{code/GaussElimination.cpp}
...
\subsection{Dinic}
\lstinputlisting{code/Dinic.txt}

\subsection{ISAP}
\lstinputlisting{code/ISAP.txt}

\subsection{MCMF}
\lstinputlisting{code/MCMF.cpp}

\subsection{Hopcroft-Karp}
\lstinputlisting{code/HopcroftKarp.txt}

\subsection{Cover / Independent Set}
\lstinputlisting{code/CoverIndepend.txt}

\subsection{KM}
\lstinputlisting{code/KM.txt}
