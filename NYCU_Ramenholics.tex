...
\subsection{Vimrc}
\lstinputlisting{code/basic/Vimrc.txt}

\subsection{Run.sh}
\lstinputlisting{code/basic/Runsh.txt}
...
\section{Python}
\subsection{I/O}
\lstinputlisting{code/python/PythonIO.txt}

\subsection{Decimal}
\lstinputlisting{code/python/PythonDecimal.txt}

\section{Data Structure}

\subsection{Heavy Light Decomposition}
\lstinputlisting{code/data_structure/HeavyLightDecomposition.txt}
...
\lstinputlisting{code/number_theory/PollardRho.txt}

\subsection{Miller Rabin}
\lstinputlisting{code/number_theory/MillerRabin.txt}
...
\lstinputlisting{code/number_theory/ExtGCD.cpp}

\subsection{Mu}
\lstinputlisting{code/number_theory/Mu.txt}

\subsection{Phi}
\lstinputlisting{code/number_theory/Phi.txt}
...
\lstinputlisting{code/linear_algebra/GaussElimination.cpp}
