// std_abs. disjoint half-open ranges [l, r) in a set.
// split(l,r): remove & return all pieces covering [l,r) (cuts at l, r)
// insert(l,r): add [l,r) (must be disjoint from S), merges neighbours
struct RangeSet { // [l, r)
  set <pii> S;
  void cut(int x) {
