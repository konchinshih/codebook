...
= Data Structure
  ...
  #sub("Wavelet Matrix", "code/data-structure/WaveletMatrix.cpp")
  #sub("Range Set", "code/data-structure/RangeSet.cpp")
  #sub("Incremental Min Sum", "code/data-structure/IncrementalMinSum.cpp")
